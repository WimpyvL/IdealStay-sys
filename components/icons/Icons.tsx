...
export const KitchenIcon: React.FC<IconProps> = (props) => (
...
export const ParkingIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V14.25m-17.25 4.5v-1.875a3.375 3.375 0 013.375-3.375h1.5a1.125 1.125 0 011.125 1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5A3.375 3.375 0 016.75 12h1.5a1.125 1.125 0 011.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125h-1.5A3.375 3.375 0 013.375 9v-1.875" /></svg>
);
...
export const AirConIcon: React.FC<IconProps> = (props) => (
...
export const DryerIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const HairDryerIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v1m0 3v1m0 3v1m-3-5h6M9 9.75a3 3 0 013-3h.008a3 3 0 013 3v1.5a3 3 0 01-3 3H12a3 3 0 01-3-3v-1.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 15.75v3.75m-3-2.25h6" />
    </svg>
);

export const HeatingIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75h15M4.5 15.75h15M4.5 9.75h15M4.5 6.75h15" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 4.5v15" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 4.5v15" />
    </svg>
);

export const IronIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 19.5v-5.25m0 0l-2.25-2.25M12.75 14.25l2.25-2.25M12.75 14.25v5.25M18.75 12H5.25c-.621 0-1.125.504-1.125 1.125v2.25c0 .621.504 1.125 1.125 1.125h13.5c.621 0 1.125-.504 1.125-1.125v-2.25c0-.621-.504-1.125-1.125-1.125z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 9V6.75a3 3 0 013-3h0a3 3 0 013 3V9" />
    </svg>
);
...
export const UserGroupIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM3 13.5a9 9 0 0118 0v.75M3 13.5V12a9 9 0 0118 0v1.5m-9 3.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
    </svg>
);
...
export const CloudArrowUpIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M17.25 21H6.75a4.5 4.5 0 01-4.5-4.5V7.5a4.5 4.5 0 014.5-4.5h7.5a4.5 4.5 0 014.5 4.5v4.5m-4.5 0h-3" />
    </svg>
);
...
export const MapIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.5-12.75l-7.5 3L3 6m18 0l-7.5 3L9 6.75m0 0l-2.25 1.125M12 12.75l-2.25 1.125M12 12.75l2.25 1.125M12 12.75V15m-4.5-3l-2.25 1.125M16.5 9.75l-2.25 1.125" />
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px" {...props}>
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.902,35.61,44,29.592,44,24C44,22.659,43.862,21.35,43.611,20.083z"/>
    </svg>
);

export const AppleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M12.01,16.095c-1.309,0-2.223-0.741-3.32-0.741c-1.12,0-2.112,0.741-3.284,0.741c-1.286,0-2.483-0.849-3.342-2.368c-1.46-2.583-0.739-6.33,1.604-8.381c0.811-0.72,1.825-1.166,2.851-1.18c1.237,0,2.335,0.803,3.093,0.803c0.732,0,1.96-0.852,3.349-0.78c1.396,0.076,2.83,0.66,3.618,1.865c-1.745,1.054-2.88,2.83-2.88,4.86c0,2.23,1.48,3.58,3.018,4.524c-0.88,1.46-1.89,2.23-3.26,2.23c-1.066,0-1.853-0.62-3.138-0.62C13.886,16.714,13.111,16.095,12.01,16.095z M14.38,8.232c0.748-0.9,1.29-2.14,1.139-3.383c-1.031,0.027-2.223,0.633-3.011,1.523c-0.678,0.765-1.332,2.05-1.139,3.223C12.42,10.595,13.623,9.99,14.38,8.232z"/>
    </svg>
);
