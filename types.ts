...
export interface Booking {
  ...
  guest?: User;
  host?: User;
  // Flattened guest/user join fields returned by booking endpoints
  ...
  // Review information (populated via joins)
  review_id?: number;
...
export type Page = 'Explore' | 'Host Dashboard' | 'Admin Dashboard' | 'Messages' | 'Bookings' | 'Financials' | 'Verify Email' | 'Settings';
